...
export function MelloShowcase({ onBack }: MelloShowcaseProps) {
  const [currentState, setCurrentState] = useState<'idle' | 'talking' | 'waving' | 'celebrating' | 'thinking'>('idle');
  ...
  const states = [
    ...
    },
    {
      ...
      message: 'Let me help you learn! I can provide tips and encouragement!'
    },
    {
    ...
    },
    {
      ...
      message: 'Hmm, let me think about the best way to help you...'
    }
  ];
      ...
      <header className="sticky top-0 z-40 border-b border-[#273043] bg-[#0B0F19]/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <h1 className="text-lg font-semibold text-white">Mello Showcase</h1>
            <div className="w-20" />
          </div>
        </div>
      </header>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-[#B9C2D0] max-w-2xl mx-auto">
            Your friendly AI cloud companion that makes learning fun and engaging
          </p>
        </div>
        ...
        <Card className="bg-[#141A2A] border-[#273043] mb-12">
          <CardHeader>
            <CardTitle className="text-white text-center">Current State: {states.find(s => s.state === currentState)?.name}</CardTitle>
          </CardHeader>
          ...
          {states.map((stateConfig, index) => (
            ...
            >
              <CardContent className="p-6 text-center">
                ...
                <Button
                  className="bg-gradient-to-r from-[#7A3CF4] to-[#4B8BFF] text-white rounded-lg px-4 py-2 text-sm"
                >
                  Try This State
                </Button>
              </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card className="bg-[#141A2A] border-[#273043]">
            <CardHeader>
              <CardTitle className="text-white">🎨 Design Details</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3 text-[#B9C2D0]">
        ...
        <Card className="mt-8 bg-gradient-to-br from-[#141A2A] to-[#273043] border-[#7A3CF4]/30">
          <CardContent className="p-8">
            ...
            <p className="text-[#B9C2D0] text-center max-w-3xl mx-auto leading-relaxed">
              Mello appears throughout the app to provide encouragement, tips, and guidance. 
              With multiple emotional states and contextual messages, Mello makes learning more 
              engaging and fun for students aged 8-18. Click on different states above to see 
              Mello in action!
            </p>
          </CardContent>
        </Card>
