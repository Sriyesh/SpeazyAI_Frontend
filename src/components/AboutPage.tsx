  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-10">
        ...
        <Sparkles className="absolute top-40 right-32 w-5 h-5 text-[#3B82F6] animate-pulse" style={{ animationDelay: '0.5s' }} />
        <Heart className="absolute bottom-40 left-40 w-4 h-4 text-[#00B9FC] animate-pulse" style={{ animationDelay: '1s' }} />
        <Star className="absolute bottom-20 right-20 w-5 h-5 text-[#FFD600] animate-pulse" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <header className="bg-white/90 backdrop-blur-md border-b border-gray-200 sticky top-0 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <h1 className="text-xl text-[#1E3A8A]">
              About Us
            </h1>
            <div className="w-20" />
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        ...
        <div className="text-center mb-16 radial-gradient-hero py-12">
          <h2 className="text-5xl md:text-6xl text-[#1E3A8A] mb-6">
            Speech Skills AI
          </h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              <CardContent className="p-6">
                <div className={`w-16 h-16 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg`}>
