...
export function HomePage({ onNavigate }: HomePageProps) {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Lessons crafted by professional speech coaches and educators to ensure effective learning outcomes",
    ...
    },
    {
      ...
      description:
        "Engaging exercises, real-world scenarios, and gamified learning to keep students motivated",
    ...
    },
    {
      ...
      title: "Safe & Secure",
      description:
        "Child-safe environment with privacy protection and parental controls built-in",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  variant="outline"
                  className="h-14 px-8 border-2 border-white/60 text-white hover:bg-white/10 rounded-2xl transition hover:scale-105 text-lg"
                >
                ...
                <div>
                  <div className="flex items-center gap-1 mb-1">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className="w-4 h-4 text-[#FFD600] fill-[#FFD600]"
                      />
                    ))}
                  </div>
